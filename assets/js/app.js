/******/ (function (modules) {
      ...
      /***/ function (module, exports) {
        $(function () {
          ...
          if (password) {
            ...
            $.get(
              "".concat(MapasCulturais.baseURL, "auth/passwordvalidationinfos"),
              function (data) {
                if (data.passwordRules.passwordMustHaveCapitalLetters) {
                  rules.push(passwordMustHaveCapitalLetters);
                  $("#passwordRulesUL").append(
                    "<li> ".concat(
                      MapasCulturais.labels.multiplelocal
                ...
                if (data.passwordRules.minimumPasswordLength) {
                  minimumPasswordLength =
                    data.passwordRules.minimumPasswordLength;
                }

                $("#passwordRulesUL").append(
                  "<li> "
                    .concat(
                      MapasCulturais.labels.multiplelocal.minimumPasswordLength,
                      " "
                    )
                    .concat(minimumPasswordLength, " </li>")
                );
            ...
            password.addEventListener("keyup", function () {
              ...
              var currentPercentPasswordCorrect =
                (prog * 100) / (rulesLength + 1);

              if (pwd.length > minimumPasswordLength - 1) {
                currentPercentPasswordCorrect =
                  currentPercentPasswordCorrect + percentToAdd;
              }

              document.getElementById("progresslabel").innerHTML = "".concat(
                currentPercentPasswordCorrect.toFixed(0),
                "%"
              );
              document.getElementById("progress").value = "".concat(
                currentPercentPasswordCorrect.toFixed(2)
              );
            });
          }
  ...
  \*****************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        __webpack_require__(
          /*! /home/isaquemelo/Documents/mapasculturais-aldirblanc/plugins/plugin-MultipleLocalAuth/assets-src/js/app.js */ "./js/app.js"
        );
        module.exports = __webpack_require__(
          /*! /home/isaquemelo/Documents/mapasculturais-aldirblanc/plugins/plugin-MultipleLocalAuth/assets-src/sass/app.scss */ "./sass/app.scss"
        );
